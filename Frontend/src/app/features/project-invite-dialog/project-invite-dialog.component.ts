...
export interface ProjectInviteDialogData {
  projectId: string;
  projectName: string;
...
@Component({
  ...
  styleUrls: ['./project-invite-dialog.component.css']
})
export class ProjectInviteDialogComponent implements OnDestroy {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public data: ProjectInviteDialogData
  ) {
